...
class AnotherTestForm extends Base
{
...
class Test_Base extends \PHPUnit_Framework_TestCase
{
	...
	public function test_multiple_form_models_have_unique_data()
	{		TestForm::load( $this->test_data );
		$this->assertEquals( array(), AnotherTestForm::all() );
	}
}